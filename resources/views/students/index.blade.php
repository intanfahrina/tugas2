            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/logout') }}" class="btn btn-success btn-sm" title="Add New Student">
                            <i class="fa fa-plus" aria-hidden="true"></i> logout
                        </a>

                        <a href="{{ url('/studentexport') }}" class="btn btn-success btn-sm" title="Add New Student">
